...
if __name__ == '__main__':
    ...
    print("Insertamos 1"); tree[1] = 'A'; preorder_indent_BST_alt(tree,tree.root(),0)
    print("Insertamos 2"); tree[2] = 'B'; preorder_indent_BST_alt(tree,tree.root(),0)
    print("Insertamos 3"); tree[3] = 'C'; preorder_indent_BST_alt(tree,tree.root(),0)
    print("Insertamos 4"); tree[4] = 'D'; preorder_indent_BST_alt(tree,tree.root(),0)
    print("Insertamos 5"); tree[5] = 'E'; preorder_indent_BST_alt(tree,tree.root(),0)
    print("Insertamos 6"); tree[6] = 'F'; preorder_indent_BST_alt(tree,tree.root(),0)
    print("Insertamos 7"); tree[7] = 'G'; preorder_indent_BST_alt(tree,tree.root(),0)
